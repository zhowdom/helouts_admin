    ...
    <div class="indexBoxInner rela">
          ...
          <div v-show="vshowFlag" class="leftMain fl" :class="{ 'animate__animated animate__slideInLeft':openStatus, 'animate__animated animate__fadeInLeft':closeStatus }">
            ...
            <div class="visitStatistic bdbox commonTitlebox comBoderAndBg" style="height:170px!important;margin-top:0!important;">
              <div class="main1 flex-row">
                ...
                <span class="txt1">当前状态</span>
                <span class="word1">current&nbsp;state</span>
              ...
              <div v-if="indexData.spaceHealthy" class="mabboxB-l mabboxB-l_v2 fl clearfix" style="margin-top:20px!important;">
                    <div class="fl eacc rela" style="margin-left:14px;">
                      <div class="topPP abs clearfix">
                        <i class="fl"></i><span class="fl">健康</span>
                      </div>
                      <p>{{indexData.spaceHealthy.health}}</p>
                    ...
                    <div class="fl eacc rela" style="margin-left:45px;margin-right:45px;">
                      ...
                      <p>{{indexData.spaceHealthy.comfortable}}</p>
                      <div class="botPP abs">个房间</div>
                    </div>
                    <div class="fl eacc rela">
                      ...
                      <p>{{indexData.spaceHealthy.safety}}</p>
                      <div class="botPP abs">个房间</div>
                    </div>
                  </div>
            ...
            <!--5-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:238px;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <span class="txt1">状态统计</span>
                  <span class="word1">Status&nbsp;situation</span>
                ...
                <div id="echrMain3Bar" style="width: 490px;height: 183px;"></div>
            </div>
            ...
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:250px;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <span class="txt1">异常指标排行</span>
                  <span class="word1" style="margin-left:40px;">Abnormal&nbsp;index&nbsp;ranking</span>
                ...
                <div v-if="indexData.alarmRank" class="mabboxT-l-topBT" style="padding-left:16px;">
                  <p v-for="(item, index) in indexData.alarmRank" :key="index" class="clearfix" style="margin-bottom:13px!important;">
            ...
            <!--5-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:280px;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <span class="txt1">全年环境有序天数统计</span>
                  <div class="mod2 flex-col" style="margin-left:340px;"></div>
                  <div class="mod3 flex-col"></div>
                </div>
                <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:481px;"></div>
                <div id="echrMain3Pie" style="width: 490px;height: 215px;"></div>
            </div>
          ...
          <div v-show="vshowFlag" class="rightMain fr" :class="{ 'animate__animated animate__slideInRight':openStatus, 'animate__animated animate__fadeInRight':closeStatus }">
            ...
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg fr" style="width:520px;height:968px;border:none;background:#283353;border-top-left-radius:0;border-bottom-left-radius:0;margin-top:0!important;">
                <div class="main1 flex-row" style="width:500px;">
                  <div class="mod1 flex-col"></div>
                  <span class="txt1">环境空间</span>
                  <span class="word1">Room&nbsp;list</span>
      ...
      <el-dialog
        ...
        <div class="hwcdBox" style="padding:10px;background:#2a3044;border-radius:4px;margin-top:10px;">
          <el-carousel class="hwcdBoxTAB" height="210px" direction="horizontal" :autoplay="false">
            <el-carousel-item>
              <div id="echrMain" style="width: 460px;height: 180px;"></div>
            </el-carousel-item>
            <el-carousel-item>
              <div id="echrMain2" style="width: 460px;height: 180px;"></div>
            </el-carousel-item>
            <el-carousel-item>
              <div id="echrMain3" style="width: 460px;height: 180px;"></div>
            </el-carousel-item>
          </el-carousel>
  ...
  methods: {
    ...
    queryIndexData () {
      return new Promise((resolve, reject) => {
        this.$axios.get('/api/digital/GetEnvironmentStatus').then(({data}) => {
          if (data.code == 200) {
        ...
        series: [
          {
            ...
            type: 'line',
            smooth: true,
            data: [5,80,136,1710,310,420,2500,1000,800],
            itemStyle: {
              // 设置线条上点的颜色（和图例的颜色）
              normal: {
                color: '#64c0f9',
    ...
    myEcharts2 () {
      var myChart = echarts.init(document.getElementById('echrMain2'))
        ...
        series: [
          {
            ...
            type: 'line',
            smooth: true,
            data: [5,80,36,110,3310,220,500,1900,100],
            itemStyle: {
              // 设置线条上点的颜色（和图例的颜色）
              normal: {
                color: '#64c0f9',
    ...
    myEcharts3 () {
      var myChart = echarts.init(document.getElementById('echrMain3'))
        ...
        series: [
          {
            ...
            type: 'line',
            smooth: true,
            data: [555,10,136,3710,5010,420,2500,500,120],
            itemStyle: {
              // 设置线条上点的颜色（和图例的颜色）
              normal: {
                color: '#64c0f9',
    ...
    showVisibleEirn (row) {
      ...
      blu_event("环境状态设备弹窗", row.deviceCode)
    },
    handleCloseEirn () {
      this.visibleEirn = false
      blu_event("环境状态设备弹窗关闭", 'null')
    },
    myEcharts3Bar () {
      ...
      var option = {
        ...
        dataset: {
          ...
          source: this.indexData.spaceHealthList && this.indexData.spaceHealthList.map(item => {
            return {
    ...
    myEcharts3Pie () {
      ...
      var option = {
          ...
          series: [{
              ...
              data: this.indexData.yearCount.map((v, index) => {
                let colorArr = ['#4B7DF8FF', '#FF6F6FFF', '#FD9544FF']
    ...
    format(percentage) {
      let res = this.indexData.alarmRank.find(v => (v.rate*100).toFixed(0) == percentage)
      if (res) {
        return `${res.count}次`;
      }
    },
    ...
    executeProgressBar () {
      // 需要等后端修改
      this.indexData.alarmRank && this.indexData.alarmRank.forEach((v, index) => this.increase(index, (v.rate*100).toFixed(0)))
      this.$forceUpdate()
    },
  }
}
