    ...
    <div class="indexBoxInner rela">
      ...
      <div class="mainWrapper clearfix">
          ...
          <div v-show="vshowFlag" class="leftMain fl" :class="{ 'animate__animated animate__slideInLeft':openStatus, 'animate__animated animate__fadeInLeft':closeStatus }">
            ...
            <!--来访统计-->
            <div class="visitStatistic bdbox commonTitlebox comBoderAndBg" style="margin-top:0!important;">
              <div class="main1 flex-row">
                <div class="mod1 flex-col"></div>
                <span class="txt1">设备概况</span>
                <span class="word1">Equipment&nbsp;Overview</span>
              ...
              <div class="visitStatistic-main clearfix">
                <div v-if="indexData.deviceCount" class="vs-ml fl" style="width:340px;">
                  <div class="esmallbox clearfix rela" style="margin-top:11px;margin-left:15px;">
                    <div class="esmall fl">
                      <div class="estitle">设备总数</div>
                      <div class="esvalue txtc rela">{{indexData.deviceCount.totalCount}}</div>
                    </div>
                    <div class="esmall fr">
                      <div class="estitle">运行设备数</div>
                      <div class="esvalue txtc rela">{{indexData.deviceCount.runningCount}}</div>
                    </div>
                    
                  </div>
                  <div class="emainbox clearfix" style="margin-top:15px;margin-left:15px;">
                    <div class="esmall fl">
                      <div class="estitle">故障设备数</div>
                      <div class="esvalue txtc rela">{{indexData.deviceCount.failureCount}}</div>
                    </div>
                ...
                <div class="vs-mr fr rela" style="margin-right:10px;">
                  ...
                  <span class="vsmrname abs">占用率</span>
                  <span v-if="indexData.deviceCount" class="vsmrname abs percentVALUES" style="bottom:45px!important;"><i>{{(Number(indexData.deviceCount.runningRate.replace('%', ''))).toFixed(0)}}</i><sub>%</sub></span>
                  <div class="echrMainBingBox abs">
                      <div id="echrMainBing1" style="width:110px;height:110px;"></div>
                  </div>
            ...
            <!--来访统计-->
            <div class="visitStatistic bdbox commonTitlebox comBoderAndBg">
              <div class="main1 flex-row">
                <div class="mod1 flex-col"></div>
                <span class="txt1">报警统计</span>
                <span class="word1">Alarm&nbsp;statistics</span>
                <div class="mod2 flex-col"></div>
                <div class="mod3 flex-col"></div>
              </div>
              ...
              <div class="visitStatistic-main clearfix">
                <div class="vs-ml fl" style="width:340px;">
                  <div v-if="indexData.alarmCount" class="esmallbox clearfix rela" style="margin-top:11px;margin-left:15px;">
                    <div class="esmall estitle2 fl rela" style="height:40px;width:300px;">
                      <div class="esvalue rela clearfix">
                        ...
                        <span class="fr" style="margin-right:10px;">{{indexData.alarmCount.processCount.totalCount}}</span>
                      </div>
                    </div>

                    <div class="esmall estitle2 fl rela" style="height:40px;width:300px;margin-top:14px;margin-bottom:14px;">
                      <div class="esvalue rela clearfix">
                        <span class="fl" style="margin-left:10px;">已处理报警</span>
                        <span class="fr" style="margin-right:10px;">{{indexData.alarmCount.processCount.processedCount}}</span>
                      </div>
                    </div>
                    ...
                    <div class="esmall estitle2 fl rela" style="height:40px;width:300px;">
                      <div class="esvalue rela clearfix">
                        ...
                        <span class="fr" style="margin-right:10px;">{{indexData.alarmCount.processCount.unProcessedCount}}</span>
                      </div>
                    </div>
                ...
                <div class="vs-mr fr rela" style="margin-right:10px;">
                  ...
                  <span v-if="indexData.alarmCount" class="vsmrname abs percentVALUES" style="bottom:45px!important;"><i>{{(indexData.alarmCount.processCount.rate*100).toFixed(0)}}</i><sub>%</sub></span>
                  <div class="echrMainBingBox abs">
            ...
            <!--5-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:220px;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <span class="txt1">设备使用率排行</span>
                  <span class="word1" style="margin-left:58px;">Device&nbsp;ranking</span>
                  <div class="mod2 flex-col" style="margin-left:134px;"></div>
                  <div class="mod3 flex-col"></div>
                </div>
                <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:481px;margin-bottom:15px;"></div>
                <div v-if="indexData.useRank" class="mabboxT-l-topBT mabboxT-l-topBT_v2" style="padding-left:16px;">
                  <p v-for="(item, index) in indexData.useRank" :key="index" class="clearfix" style="margin-bottom:7px;">
                    <el-tooltip class="item" effect="dark" :content="item.spaceName" placement="top-start">
                      <span class="fl esname eplise">{{item.spaceName}}</span>
                    </el-tooltip>
            ...
            <!--5-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:278px;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <span class="txt1">机电设备资产统计</span>
                ...
                <div id="echrMain" style="width: 490px;height: 218px;"></div>
            </div>
          ...
          <div v-show="vshowFlag" class="rightMain fr" :class="{ 'animate__animated animate__slideInRight':openStatus, 'animate__animated animate__fadeInRight':closeStatus }">
              ...
              <!--3个页面右侧公共组件-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg fr" style="width:520px;height:968px;border:none;background:#283353;border-top-left-radius:0;border-bottom-left-radius:0;margin-top:0!important;">
                <div class="main1 flex-row" style="width:500px;">
                  <div class="mod1 flex-col"></div>
                  <span class="txt1">机电设施</span>
                  <span class="word1">Electromechanical&nbsp;facilities</span>
                  <div class="mod2 flex-col" style="margin-left:179px;"></div>
                  <div class="mod3 flex-col"></div>
                </div>
                ...
                <div class="three3CommBox rela" style="margin-top:15px;">
                  <div class="toToufu toToufuEnvi" style="margin-bottom:80px;height:261px;overflow-y: scroll;">
                    <ul v-if="indexData.deviceTypeList" class="clearfix">
                      <li @click="getTypeId('', -1)" class="fl" :class="{'hoverClassT': curTypeIndex == -1}">全部设备</li>
                      <li @click="getTypeId(item.typeId, index)" v-for="(item, index) in indexData.deviceTypeList" :key="index" class="fl eplise" :title="item.typeName" :class="{'hoverClassT': index == curTypeIndex}">{{item.typeName}}</li>
                    </ul>

                    <div class="clearfix" style="border-bottom:1px solid #09132B99;margin-bottom:10px;width:480px;margin-left:10px;"></div>
                    <ul v-if="indexData.spaceList" class="clearfix">
                      <li @click="getSpeaceId('', -1)" class="fl" :class="{'hoverClassT': curSpeaceIndex == -1}">全部空间</li>
                      <li @click="getSpeaceId(item.spaceId, index)" v-for="(item, index) in indexData.spaceList" :key="index" class="fl eplise" :title="item.spaceName" :class="{'hoverClassT': index == curSpeaceIndex}">{{item.spaceName}}</li>
                    </ul>
                  </div>
                  <div class="toSearch clearfix abs">
                    <el-input class="fl" v-model="inputSearch" clearable placeholder="请输入设备名称"></el-input>
                    <el-button class="fl" type="primary" @click="search(1)" :loading="loading">查询</el-button>
                  </div>
                  <div class="toTable">
                    <el-table
                      ...
                      v-loading="loading"
                      :data="tableData"
                      @row-click="showdidialog"
                      style="width: 100%;height:528px;overflow-y: scroll;background-color:#1d263e!important;">
                      ...
                      <el-table-column
                        ...
                        <template slot-scope="{row}">
                          <p v-if="!row.status" style="color:#fff">离线</p>
                ...
                <!--左侧悬浮菜单-->
              <div class="cmABSMenu cmABSMenuv2 abs bdbox clearfix needHIDE" style="height:52px;left:122px;top:10px;">
                  <div class="ecmns fr bdbox" @click="handleOpenFold('close')"><span>收起</span></div>
              </div>
              <!--楼层悬浮菜单-->
              <div class="parkAndvedioMonBoxL parkAndvedioMonBoxLv2 parkAndvedioMonBoxL_v2 fl bdbox commonTitlebox abs clearfix needHIDE" style="top:531px;left:94px;">
                <div class="parkAndvedioMonBoxLIN bdbox" :class="{ 'animate__animated animate__smallMenuFade': hoverStatus2 == 1, 'animate__animated animate__smallMenuFadeOut': hoverStatus2 == 0}" id="hoverOpacityBox2">
                  <div class="main1 flex-row" style="width:88px;">
                    <div class="mod1 flex-col"></div>
                    <span class="txt1">楼层</span>
                    <!-- <i class="layerTxt">F1</i> -->
                  </div>
                  <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:32px;margin-bottom:10px;"></div>
                  <div class="elevatorMenuBox">
      ...
      <el-dialog
        title=""
        :visible.sync="visibleEirn"
        :before-close="handleCloseEirn"
        custom-class="dzDialogStyle_eqp dzDialogStyle_eqpv2 rela">
        <div class="dzDialogHeader clearfix abs">
          <div class="fl"></div>
          <div class="rightBBar">
            1F-106空调
        ...
        <div class="clearfix wnlistbox">
          <div class="clearfix eechliv2 rela fl">
            <div><i class="cm_daoTriangle_bg abs"></i><span class="eplise" style="color:#fff;padding-left:10px;padding-top:3px;display:inline-block;">滤网报警</span></div>
            <div style="color:#32C5FF;padding-left:10px;">正常</div>
          </div>
          <div class="clearfix eechliv2 rela fr">
            <div><i class="cm_daoTriangle_bg abs"></i><span class="eplise" style="color:#fff;padding-left:10px;padding-top:3px;display:inline-block;">防冻报警</span></div>
            <div style="color:#c9505f;padding-left:10px;">报警</div>
          </div>
          <div class="clearfix eechliv2 rela fl">
            <div><i class="cm_daoTriangle_bg abs"></i><span class="eplise" style="color:#fff;padding-left:10px;padding-top:3px;display:inline-block;">风机压差</span></div>
            <div style="color:#32C5FF;padding-left:10px;">正常</div>
          </div>
          <div class="clearfix eechliv2 rela fr">
            <div><i class="cm_daoTriangle_bg abs"></i><span class="eplise" style="color:#fff;padding-left:10px;padding-top:3px;display:inline-block;">风机故障状态</span></div>
            <div style="color:#32C5FF;padding-left:10px;">正常</div>
          </div>
          <div class="clearfix eechliv2 rela fl">
            <div><i class="cm_daoTriangle_bg abs"></i><span class="eplise" style="color:#fff;padding-left:10px;padding-top:3px;display:inline-block;">静电滤网状态</span></div>
            <div style="color:#32C5FF;padding-left:10px;">正常</div>
          </div>
          <div class="clearfix eechliv2 rela fr">
            <div><i class="cm_daoTriangle_bg abs"></i><span class="eplise" style="color:#fff;padding-left:10px;padding-top:3px;display:inline-block;">手自动状态</span></div>
            <div style="color:#32C5FF;padding-left:10px;">正常</div>
          </div>
          <div class="clearfix eechliv2 rela fl">
            <div><i class="cm_daoTriangle_bg abs"></i><span class="eplise" style="color:#fff;padding-left:10px;padding-top:3px;display:inline-block;">风机运行状态</span></div>
            <div style="color:#32C5FF;padding-left:10px;">停止</div>
          </div>
        </div>

        <div class="hwcdBox" style="padding:10px;background:#2a3044;border-radius:4px;margin-top:10px;">
          <div class="clearfix" style="border-bottom:1px solid #1f253d;padding-bottom:5px;">
            <h3 class="fl" style="color:#32C5FF;">回风温湿度</h3>
          </div>
          
          <div class="mabboxB-l mabboxB-l_v2 clearfix" style="margin-top:5px!important;">
            <div class="fl eacc rela" style="margin-left:14px;height:57px!important;background:#1e2437;">
              <div class="topPP abs clearfix" style="width:100%;border-bottom:1px solid #131931;">
                <i class="fl"></i><span class="fl">温度</span>
              </div>
              <p>25°C</p>
            </div>
            <div class="fl eacc rela" style="margin-left:25px;margin-right:25px;height:57px!important;background:#1e2437;">
              <div class="topPP abs clearfix" style="width:100%;border-bottom:1px solid #131931;">
                <i class="fl"></i><span class="fl">湿度</span>
              </div>
              <p>34%RH</p>
            </div>
            <div class="fl eacc rela" style="height:57px!important;background:#1e2437;">
              <div class="topPP abs clearfix" style="width:100%;border-bottom:1px solid #131931;">
                <i class="fl"></i><span class="fl">回风CO2</span>
              </div>
              <p>506ppm</p>
            </div>
          </div>
  ...
  methods: {
    ...
    queryIndexData () {
      return new Promise((resolve, reject) => {
        this.$axios.get('/api/digital/GetElectricData').then(({data}) => {
          if (data.code == 200) {
    ...
    search (pgi) {
      ...
      this.loading = true
      this.$axios.post('/api/digital/getDeviceList', _params).then(({data}) => {
        if (data.code === 200) {
    ...
    showdidialog (row) {
      // this.visibleEirn = true
      blu_event("机电设施设备弹窗", row.deviceCode)
    },
    showVisibleEirn () {
      this.visibleEirn = true
    },
    handleCloseEirn () {
      this.visibleEirn = false
      blu_event("机电设施设备弹窗关闭", 'null')
    },
    myEchartsBing () {
      // 通过id获取获取画布
      const myChart = echarts.init(document.getElementById('echrMainBing1'));
      // 指定图表的配置项和数据
      let data = +(this.indexData.deviceCount && this.indexData.deviceCount.runningRate).replace('%', '');
      let option = {
        title: {
          text:'',//主标题文本
          subtext:'',//副标题文本
    ...
    myEchartsBing2 () {
      ...
      // 指定图表的配置项和数据
      let data = this.indexData.alarmCount && (this.indexData.alarmCount.processCount.rate*100).toFixed(0);
      let option = {
        title: {
          text:'',//主标题文本
          subtext:'',//副标题文本
    ...
    myEcharts () {
      ...
      var option = {
        ...
        legend: {
          ...
          x: 'right',
          y: '8',
          data: this.indexData.assetsCount && this.indexData.assetsCount.map(v => v.years+''),
          textStyle: {
            color: '#32C5FF'
          }
        },
        xAxis: [{
          data: this.indexData.assetsCount && (this.indexData.assetsCount[0]['list']).map(v => v.month+''),
          axisTick:{
            show:false, 
        ...
        series: [
          {
            ...
            type: 'line',
            smooth: true,
            data: this.indexData.assetsCount && (this.indexData.assetsCount[0]['list']).map(v => v.value),
            itemStyle: {
              // 设置线条上点的颜色（和图例的颜色）
              normal: {
                color: '#64c0f9',
          ...
          },
          {
            ...
            type: 'line',
            smooth: true,
            data: this.indexData.assetsCount && (this.indexData.assetsCount[1]['list']).map(v => v.value),
            itemStyle: {
              // 设置线条上点的颜色（和图例的颜色）
              normal: {
                color: '#567bee',
          ...
          },
          {
            ...
            type: 'line',
            smooth: true,
            data: this.indexData.assetsCount && (this.indexData.assetsCount[2]['list']).map(v => v.value),
            itemStyle: {
              // 设置线条上点的颜色（和图例的颜色）
              normal: {
                color: '#3659da',
    ...
    format(percentage) {
      let res = this.indexData.useRank.find(v => ((v.rate)*100).toFixed(0) == percentage)
      if (res) {
        return `${res.hours}h`;
      }
    },
    handleCloseLayerAnother_gas () {
      ...
      blu_event("关闭设备弹窗", 'null')
    },
    handleSwitch (v, type) {
      switch (type) {
        case 'base':
          blu_event('设备显隐', JSON.stringify({"shebei": "基础", "state": v}))
          break;
        case 'top':
          blu_event('设备显隐', JSON.stringify({"shebei": "天花板", "state": v}))
          break;
        case 'desk':
          blu_event('设备显隐', JSON.stringify({"shebei": "家具", "state": v}))
          break;
        case 'gas':
          blu_event('设备显隐', JSON.stringify({"shebei": "暖通", "state": v}))
          break;
        case 'route':
          blu_event('设备显隐', JSON.stringify({"shebei": "气路", "state": v}))
          break;
      }
    },
    RoomChoose(room) {
    ...
    handleEachLayer (tab, event) {
      blu_event('楼层抽屉', tab.label.split('-')[1])
    },
    showDigitalGo () {
      this.cclickIndex = null
    ...
    executeProgressBar () {
      this.indexData.useRank && this.indexData.useRank.forEach((v, index) => this.increase(index, +((v.rate)*100).toFixed(0)))
      this.$forceUpdate()
    },
  }
}
