    ...
    <div class="indexBoxInner rela">
      ...
      <div class="mainWrapper clearfix">
          ...
          <div v-show="vshowFlag" class="leftMain fl" :class="{ 'animate__animated animate__slideInLeft':openStatus, 'animate__animated animate__fadeInLeft':closeStatus }">
            ...
            <!--每一个机器人-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:310px;border:none;background:#283353;margin-top:0!important;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <!-- <span class="txt1">能耗态势</span> -->
                  <img style="width:50px;height:23px;margin-top:5px;margin-left:10px;" src="../assets/keBG.png">
                  <span class="word1" style="font-size:20px;font-weight:bold;color:#fff;line-height:14px">ROBOT&nbsp;紫外线消杀机器人</span>
                  <div class="mod2 flex-col" style="margin-left:195px;"></div>
                  <div class="mod3 flex-col"></div>
                </div>
                <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:483px;"></div>

                <div class="robotMain">
                  <div class="robotMainT clearfix">
                    <div class="robotMainTL fl" style="margin-top:36px;margin-left:48px;">
                      <img src="../assets/myrobot.png">
                    </div>
                    <div class="robotMainTR fr bdbox">
                      <div class="robotMainTRt">
                        <div class="robotMainTRt-a clearfix">
                          <div class="robotMainTRt-a-l fl">
                            <p class="rela">
                              <i class="cm_daoTriangle_bg abs"></i>
                              <span>运行状态</span>
                            </p>
                            <div class="sseip">
                              <el-switch style="margin-left:16px;" v-model="valueRobot1" active-color="#00CCFFFF" inactive-color="#ff4949"></el-switch>
                            </div>
                          </div>
                          <div class="robotMainTRt-a-r fr">
                            <p class="rela">
                              <i class="cm_daoTriangle_bg abs"></i>
                              <span>编号</span>
                            </p>
                            <div class="bvbs"><span>LFMD66868-7862</span></div>
                          </div>
                        </div>
                        ...
                        <div class="robotMainTRt-a clearfix">
                          <div class="robotMainTRt-a-l fl">
                            ...
                            <div class="sseip">
                               <span style="margin-left:10px;">2599天</span>
                            </div>
                          </div>
                          <div class="robotMainTRt-a-r fr">
                            <p class="rela">
                              <i class="cm_daoTriangle_bg abs"></i>
                              <span>当前位置（X、Y、Z）</span>
                            </p>
                            <div class="bvbs"><span>-2.22、-23.44、0.444</span></div>
                          </div>
                        </div>

                      </div>
                      <div class="robotMainTRb">
                        <div class="robotMainTRt-a-r" style="border-bottom:none;">
                            <p class="rela">
                              <i class="cm_daoTriangle_bg abs"></i>
                              <span>位置</span>
                            </p>
                            <div class="mnass"><span>1号检测楼大厅2号房间角落</span></div>
                          </div>
                      </div>
                    </div>
                  </div>
                  <div class="robotMainB clearfix">
                    <div class="clearfix fl">
                      <span class="fl">网络状态</span>
                      <img class="fl" src="../assets/ke1.png">
                    </div>
                    <div class="clearfix fl">
                      <span class="fl">工作状态</span>
                      <img class="fl" src="../assets/ke2.png">
                    </div>
                    <div class="clearfix fl">
                      <span class="fl">告警状态</span>
                      <img class="fl" src="../assets/ke3.png">
                    </div>
                    <div class="clearfix fl" style="margin-right:0;">
                      <span class="fl">电量状态</span>
                      <img class="fl" src="../assets/ke4.png">
                    </div>
                  </div>
                </div>
            </div>
            ...
            <!--每一个机器人-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:310px;border:none;background:#283353;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <!-- <span class="txt1">能耗态势</span> -->
                  <img style="width:50px;height:23px;margin-top:5px;margin-left:10px;" src="../assets/keBG.png">
                  <span class="word1" style="font-size:20px;font-weight:bold;color:#fff;line-height:14px">ROBOT&nbsp;导览机器人</span>
                  <div class="mod2 flex-col" style="margin-left:195px;"></div>
                  <div class="mod3 flex-col"></div>
                </div>
                <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:483px;"></div>
            ...
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg" style="width:520px;height:310px;border:none;background:#283353;">
                <div class="main1 flex-row" style="width:545px;">
                  ...
                  <!-- <span class="txt1">能耗态势</span> -->
                  <img style="width:50px;height:23px;margin-top:5px;margin-left:10px;" src="../assets/keBG.png">
                  <span class="word1" style="font-size:20px;font-weight:bold;color:#fff;line-height:14px">ROBOT&nbsp;测温防控机器人</span>
                  <div class="mod2 flex-col" style="margin-left:195px;"></div>
                  <div class="mod3 flex-col"></div>
                </div>
                <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:483px;"></div>
          ...
          <div v-show="vshowFlag" class="rightMain fr" :class="{ 'animate__animated animate__slideInRight':openStatus, 'animate__animated animate__fadeInRight':closeStatus }">
              ...
              <!--每一个机器人-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg fr" style="width:520px;height:310px;border:none;background:#283353;border-top-left-radius:0;margin-top:0!important;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <!-- <span class="txt1">能耗态势</span> -->
                  <img style="width:50px;height:23px;margin-top:5px;margin-left:10px;" src="../assets/keBG.png">
                  <span class="word1" style="font-size:20px;font-weight:bold;color:#fff;line-height:14px">ROBOT&nbsp;室内巡检机器人</span>
                  <div class="mod2 flex-col" style="margin-left:195px;"></div>
                  <div class="mod3 flex-col"></div>
                </div>
                <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:483px;"></div>
            ...
            <!--每一个机器人-->
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg fr" style="width:520px;height:310px;border:none;background:#283353;">
                <div class="main1 flex-row" style="width:545px;">
                  <div class="mod1 flex-col"></div>
                  <!-- <span class="txt1">能耗态势</span> -->
                  <img style="width:50px;height:23px;margin-top:5px;margin-left:10px;" src="../assets/keBG.png">
                  <span class="word1" style="font-size:20px;font-weight:bold;color:#fff;line-height:14px">ROBOT&nbsp;保安巡检机器人</span>
                  <div class="mod2 flex-col" style="margin-left:195px;"></div>
                  <div class="mod3 flex-col"></div>
                </div>
                <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:483px;"></div>
            ...
            <div class="energyStatistic bdbox commonTitlebox comBoderAndBg fr" style="width:520px;height:310px;border:none;background:#283353;">
                <div class="main1 flex-row" style="width:545px;">
                  ...
                  <!-- <span class="txt1">能耗态势</span> -->
                  <img style="width:50px;height:23px;margin-top:5px;margin-left:10px;" src="../assets/keBG.png">
                  <span class="word1" style="font-size:20px;font-weight:bold;color:#fff;line-height:14px">ROBOT&nbsp;扫地机器人</span>
                  <div class="mod2 flex-col" style="margin-left:195px;"></div>
                  <div class="mod3 flex-col"></div>
                </div>
                <div class="linerStyle" style="margin-top:5px;margin-left:16px;width:483px;"></div>
